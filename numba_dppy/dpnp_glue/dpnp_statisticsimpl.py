...
def dpnp_amin_impl(a):
    dpnp_lowering.ensure_dpnp("amin")
    dpctl_functions = dpnp_ext._DPCTL_FUNCTIONS()
    ...
    sig = signature(ret_type, types.voidptr, types.voidptr,
                              types.voidptr, types.intp,
                              types.voidptr, types.intp)
    dpnp_max = dpnp_ext.dpnp_func("dpnp_min", [a.dtype.name, "NONE"], sig)
    ...
    def dpnp_amin_impl(a):
        ...
        dpnp_max(a_usm, out_usm, a.shapeptr, a.ndim, a.shapeptr, 0)
