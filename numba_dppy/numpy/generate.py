...
parser = argparse.ArgumentParser(description='Generate mapping and stubs required for NumPy support in Numba_dppy')
...
rewrite_function_name_map_template = env.get_template('generate_rewrite_function_name_map.tm')
