...
"""
The numba-dppy extension adds an automatic offload optimizer to
...
This example demonstrates the usage of numba-dppy's automatic offload
functionality. Note that numba-dppy should be installed in your
