CONFIG = {
    ...
    'errors' : {
        '2.7' : {
            ...
            'Lin' : {'test_all (numba.tests.test_runtests.TestCase)',
    ...
    'failures' : {
        '2.7' : {
            ...
            'Mac' : {'test_ipython (numba.tests.test_dispatcher.TestCache)',  # SAT-1070
        ...
        '3.5' : {
            'Win' : {'test_ipython (numba.tests.test_dispatcher.TestCache)', # SAT-1070
        ...
        '3.6' : {
            ...
            'Lin' : {'test_ipython (numba.tests.test_dispatcher.TestCache)',
                     'test_caching (numba.tests.test_cfunc.TestCFuncCache)',
                     'test_caching (numba.tests.test_dispatcher.TestCache)',
            },
            'Mac' : {'test_ipython (numba.tests.test_dispatcher.TestCache)',  # SAT-1070
    ...
    'validation' : {
        'errors' : {
            '2.7' : {
                ...
                'Lin' : set(),
                'Mac' : { 'test_subpackage (numba.tests.test_runtests.TestCase)', #SAT-1175
