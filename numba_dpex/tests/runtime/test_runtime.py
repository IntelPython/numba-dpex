...
from numba_dpex import runtime
from numba_dpex.runtime import _rt_python
...
def test_pointers_exposed():
    ...
    exposed("DPEX_RT_sycl_usm_array_from_python")
    exposed("DPEX_RT_sycl_usm_array_to_python_acqref")
...
def test_sycl_usm_array_interface_equals_array_struct(array):
    ...
    ret = runtime.DPEX_RT_sycl_usm_array_from_python(
